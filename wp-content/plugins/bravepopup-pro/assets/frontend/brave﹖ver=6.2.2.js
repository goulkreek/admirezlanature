...
function brave_check_field_condition(event, fieldID, formID, fieldType='input'){
   ...
   Object.keys(brave_form_conditions).forEach(function(fieldKey){
      ...
      if(Object.keys(brave_form_conditions[fieldKey]).length> 0){
         Object.keys(brave_form_conditions[fieldKey]).forEach(function(depKey){
            var fieldCondition = conditionRules[depKey];

            if(depKey === fieldID){
               if(inputData && fieldCondition.action === 'exist' && !brave_form_conditions[fieldKey][depKey]){ brave_form_conditions[fieldKey][depKey] = true; }
               if(!inputData && fieldCondition.action === 'exist' && brave_form_conditions[fieldKey][depKey]){ brave_form_conditions[fieldKey][depKey] = false; }
               
               if(fieldCondition.action === 'equal' && (inputData && (fieldCondition.value.includes(inputData))) && !brave_form_conditions[fieldKey][depKey]){ brave_form_conditions[fieldKey][depKey] = true; }
               if(fieldCondition.action === 'equal' && (!inputData || (!fieldCondition.value.includes(inputData))) && brave_form_conditions[fieldKey][depKey]){ brave_form_conditions[fieldKey][depKey] = false; }
   
               if(fieldCondition.action === 'notequal' && (inputData && (!fieldCondition.value.includes(inputData))) && !brave_form_conditions[fieldKey][depKey]){ brave_form_conditions[fieldKey][depKey] = true; }
               if(fieldCondition.action === 'notequal' && (!inputData || (fieldCondition.value.includes(inputData))) && brave_form_conditions[fieldKey][depKey]){ brave_form_conditions[fieldKey][depKey] = false;  }
            }
